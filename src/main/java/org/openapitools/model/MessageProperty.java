...
public class MessageProperty {
  ...
  public MessageProperty id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public MessageProperty name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, messageProperty.id) &&
        Objects.equals(this.name, messageProperty.name);
  }
